...
const contractId = '0x29983aaa8ea579c0409bb50d39e12e81d5d2a3e8';
const marketAccount = '0x4688666adefa124286a09d1a5a8d9972ad0f8b56';

// replace with IPFS hashes

$.getJSON('skully.json', function(data) {
  kudosMap = data;
});
...
App = {
      ...
      kudosContractInstance.balanceOf(account, function(error, balance) {
        ...
        for (let index = 0; index < balance; index++) {
          kudosContractInstance.tokenOfOwnerByIndex(account, index, function(error, kudosId) {
            kudosContractInstance.getSkullyById(parseInt(kudosId), function(error, kudos) {
      ...
      kudosContractInstance.balanceOf(account, function(error, balance) {
        ...
        for (let index = 0; index < balance; index++) {
          kudosContractInstance.tokenOfOwnerByIndex(account, index, function(error, kudosId) {
            ...
            kudosContractInstance.getSkullyById(kudosId, function(error, kudos) {
              // console.log(kudos);
              if (error != null) {
                console.error(error)
              }
  ...
  addKudosArtifact: function (kudosId, kudos, sectionId) {
    ...
    web3.eth.getAccounts(function(error, accounts) {
      ...
      if(source === undefined) {
        source = 'https://robohash.org/' + kudosId;
      }
